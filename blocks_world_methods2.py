...
pyGame.pyhop_module.pyhop.declare_methods('get', get_by_pickup, get_by_unstack)
...
pyGame.pyhop_module.pyhop.declare_methods('pickup_task', pickup_m)
...
pyGame.pyhop_module.pyhop.declare_methods('unstack_task', unstack_m)
